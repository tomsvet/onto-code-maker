...
*  Inverse Functional Object Property 2.
*  Inverse Functional 2 
    **/
...
*  Subproperty of Object Property.
*  Subproperty of
    **/
...
*  Equivalent to subproperty Object Property.
*  Equivalent to subproperty 
    **/
...
*  Subproperty of subproperty Object Property.
*  Subproperty of subproperty 
    **/
...
*  Equivalent to inverse functional Object Property.
*  Equivalent to inverse functional 
    **/
...
*  Subproperty of Inverse Functional Object Property.
*  Subproperty of inverse functional 
    **/
...
*  Equivalent to functional Object Property.
*  Equivalent to functional 
    **/
    private List<Class2Int> equivalentToFunctionalObjectProperty = new ArrayList<>();

    /**
    * Property http://example.com/subPropertyOfFunctionalObjectProperty
    * The property is SubProperty of  functionalObjectProperty
*  Subproperty of Functional Object Property.
*  Subproperty of functional 
    **/
...
*  Equivalent to equivalent Object Property.
...
*  Subproperty of Equivalent Object Property.
*  Subproperty of equivalent functional 
    **/
...
*  Union Of
    **/
    ...
    public void addNormalObjectProperty(Class2Int normalObjectProperty){
        ...
        if(!this.equivalentToSubpropertyObjectProperty.contains(normalObjectProperty)){
            this.equivalentToSubpropertyObjectProperty.add(normalObjectProperty);
        }
    ...
    public void setFunctionalObjectProperty(Class2Int functionalObjectProperty){
        ...
        if(!this.equivalentToFunctionalObjectProperty.contains(functionalObjectProperty)){
            this.equivalentToFunctionalObjectProperty.add(functionalObjectProperty);
        }
    }
    ...
    public List<Class2Int> getEquivalentToFunctionalObjectProperty(){
    ...
    public void addSubPropertyOfFunctionalObjectProperty(Class2Int subPropertyOfFunctionalObjectProperty){
        ...
        if(!this.equivalentToFunctionalObjectProperty.contains(subPropertyOfFunctionalObjectProperty)){
            this.equivalentToFunctionalObjectProperty.add(subPropertyOfFunctionalObjectProperty);
        }
    }
