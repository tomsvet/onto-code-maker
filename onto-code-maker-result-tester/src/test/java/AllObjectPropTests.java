...
/**
 *  AllObjectPropTests.java
 *
 *  Unit tests for Generated source code.
 *  Source code was generated from allObjectProp ontology.
 *
...
public class AllObjectPropTests {
    ...
    void setUp() throws FileNotFoundException {
        String[] inputFiles = {"src/main/resources/ontologies/allObjectProp.owl"};
    ...
    void equivalentToFunctionalObjectProperty() throws Exception {
        ...
        Class1 loadedC = factory.getClass1FromModel(Class1InstanceName);
        assertEquals(1,loadedC.getEquivalentToFunctionalObjectProperty().size(),"Class1 is not in the model.");
        assertEquals(Class2InstanceName,loadedC.getEquivalentToFunctionalObjectProperty().get(0).getIri().toString(),"Property values are not equal");
