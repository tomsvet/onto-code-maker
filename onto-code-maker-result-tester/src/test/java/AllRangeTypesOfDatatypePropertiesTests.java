...
/**
 * Tests to allowed data types in datatype property
 */
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class AllRangeTypesOfDatatypePropertiesTests {
    ...
    void setUp() throws FileNotFoundException {
        String[] inputFiles = {"src/main/resources/ontologies/allRangeTypesOfDatatypeProperties.owl"};
